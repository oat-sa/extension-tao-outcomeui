...
filter:!0,labels:{filter:__("Search by results")},model:[{id:"delivery",label:__("Delivery"),sortable:!1},{id:"deliveryResultIdentifier",label:__("Delivery Execution"),sortable:!1},{id:"testTakerIdentifier",label:__("Test Taker"),sortable:!1},{id:"start_time",label:__("Start Time"),sortable:!1}],paginationStrategyTop:"simple",paginationStrategyBottom:"pages",rows:25,sortby:"result_id",actions:{view:{id:"view",label:__("View"),icon:"view",action:viewResult},remove:{id:"remove",title:__("Delete result"),icon:"bin",label:__("Delete"),action:removeResult},download:{id:"download",title:__("Download result"),icon:"download",label:__("Download"),action:downloadResult
