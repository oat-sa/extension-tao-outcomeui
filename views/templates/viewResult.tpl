        ...
        <div id="resultsBox">
            ...
            <table class="matrix">
                ...
                <tr>
                    ...
                    <th>
                        <a href="#" data-result-id="<?=get_data('id')?>" data-uri="<?=$item['uri']?>" data-definition="<?=$item['internalIdentifier']?>" data-state="<?=htmlspecialchars($item['state'])?>" class="btn-info small preview" target="preview">
