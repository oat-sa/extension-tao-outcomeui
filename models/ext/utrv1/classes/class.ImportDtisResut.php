...
class ImportDtisResult {
    ...
    public function addResultVariable($dtisUris, $key, $value) {
        ...
        if (is_array($dtisUris) && !empty($key)) {
            ...
            $ins = new core_kernel_classes_Resource($matchUri);
            $labelM = (string)$ins->getLabel();

            echo "<br>".$matchUri. " <br> le label est ".$labelM;
...
$dtisArray["TAO_TEST_ID"] = "http://localhost/middleware/taoqti.rdf#test31";
$dtisArray["TAO_ITEM_ID"] = "http://localhost/middleware/taoqti.rdf#item2";
$dtisArray["TAO_SUBJECT_ID"] = "http://localhost/middleware/taoqti.rdf#subject1";
// the variable infos
$key = "Score2";
$value = "valeurs reinc1 fdfhfdh  "; //item 1 test 2";
